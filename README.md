...
Total: **311,104** lines of code across **4305** files in the top 5 languages.
...
- **Upstream**: <https://github.com/rome/tools>
...
- **Stars**: 23,381 · **Forks**: 641 · **Open issues**: 1,439 · **Contributors**: 224

## Totals (cumulative)

- **Releases**: 117 · **Merged PRs**: 2821 · **Open PRs**: 7 · **Closed issues**: 1353 · **Open issues**: 86 · **Commits**: 4309
...
Reported by **7** distros on [repology.org](https://repology.org/project/tools). **2** are ✅ on the latest upstream release, **5** are ⚠️ on an older version.
...
_Snapshot: `data/card/260911.yml` · 2026-09-11T20:46:49Z._
